...
: ${AMENT_CURRENT_PREFIX:="/home/senai/omnibot_ws/src/omniBot/install/omnibot_ignition"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/omnibot_ignition/environment/omnibot_ignition.sh"
