...
{
  new (message_memory) keyboard_interface::msg::KeyEvent(_init);
}

void KeyEvent_fini_function(void * message_memory)
{
  auto typed_message = static_cast<keyboard_interface::msg::KeyEvent *>(message_memory);
  typed_message->~KeyEvent();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyEvent_message_member_array[2] = {
  {
    "event",  // name
    ...
    offsetof(keyboard_interface::msg::KeyEvent, event),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(keyboard_interface::msg::KeyEvent, key),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyEvent_message_members = {
  ...
  2,  // number of fields
  sizeof(keyboard_interface::msg::KeyEvent),
...
get_message_type_support_handle<keyboard_interface::msg::KeyEvent>()
{
  return &::keyboard_interface::msg::rosidl_typesupport_introspection_cpp::KeyEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, keyboard_interface, msg, KeyEvent)() {
  return &::keyboard_interface::msg::rosidl_typesupport_introspection_cpp::KeyEvent_message_type_support_handle;
}
